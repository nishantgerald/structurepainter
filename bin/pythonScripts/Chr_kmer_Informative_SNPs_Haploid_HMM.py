...
def select_informative_SNPs(chr_strands,prob_pops,ADMIX2,diff_quantile = 0.1):	
...
def create_kmer_haplotypes(chr_strands,kmer):
...
<<<<<<< HEAD
def write_to_db(evaluation,time,window_size,sliding_window,random_seed,batch_size):
